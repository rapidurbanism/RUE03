...
import { getArrDepth, isColl, isPosi, isPgon, isPline, isPoint } from '../../../libs/geo-info/id';
import { vecDiv, vecSum, vecAvg, vecFromTo, vecLen, vecCross, vecNorm, vecAdd, vecSetLen, vecDot } from '../../../libs/geom/vectors';
import { isRay, isPlane, isXYZ } from '../../../libs/geo-info/virtual';
import { rayFromPln } from '../../inline/_ray';
import { plnFromRay } from '../../inline/_plane';
